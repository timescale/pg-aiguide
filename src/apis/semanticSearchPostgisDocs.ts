...
const inputSchema = {
  ...
  prompt: z
    .string()
    .describe(
      'The natural language query used to search the PostGIS documentation for relevant information.',
    ),
} as const;
...
export const semanticSearchPostgisDocsFactory: ApiFactory<
  ServerContext,
  typeof inputSchema,
  typeof outputSchema,
  z.infer<(typeof outputSchema)['results']>
> = ({ pgPool, schema }) => ({
  name: 'semantic_search_postgis_docs',
  method: 'get',
  route: '/semantic-search/postgis-docs',
  config: {
    title: 'Semantic Search of PostGIS Documentation Embeddings',
    description:
      'This retrieves relevant documentation entries based on a natural language query. The content covers PostGIS spatial database extension topics including geometry types, spatial functions, indexing, and GIS operations.',
    inputSchema,
    outputSchema,
  },
